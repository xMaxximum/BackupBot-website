...
const { data: guilds } = useLazyFetch(`${appConfig.apiBase}/getguilds/${discord.token}`, {
  method: 'GET',
...
<template>
  <div v-if="guilds">
    <div>
      <ul class="flex items-center justify-center space-x-5 sm:space-x-10 h-screen flex-wrap pl-7 pr-7">
        <li v-for="guild in guilds" class="hover:scale-150">
          <div class="avatar">
  ...
  <div v-else class="text-center h-20 items-center justify-center flex">
    <div role="status">
